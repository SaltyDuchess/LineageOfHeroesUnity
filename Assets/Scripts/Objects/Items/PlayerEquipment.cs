...
public class PlayerEquipment : MonoBehaviour
{
    ...
    public void UpdateStats(Player player, SpellManager spellbook, UIAbilityBox abilityBoxPrefab)
    {
        // Reset stats
        bonusHp = 0;
        bonusHpRegen = 0;
        ...
        UpdateEquippedCape(ref equippedCape, ref previousCape, player, spellbook, abilityBoxPrefab);
    }
    ...
    private void UpdateEquippedCape(ref Cape equippedCape, ref Cape previousCape, Player player, SpellManager spellManager, UIAbilityBox abilityBoxPrefab)
    {
            ...
            if (equippedCape != previousCape)
            {
                if (previousCape != null)
                {
                    spellManager.RemoveSpell(previousCape.boundAbility);
                		ClearAbilityBoxesWithSpell(previousCape.boundAbility, abilityBoxPrefab);
                }
    ...
    private void ClearAbilityBoxesWithSpell(Spells spellToRemove, UIAbilityBox abilityBoxPrefab)
    {
